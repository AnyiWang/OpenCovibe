  ...
  <div class="w-full max-w-[80%]">
    {#if isAsk && (tool.status === "running" || tool.status === "ask_pending") && askQuestion}
      ...
      <div class="rounded-lg border border-yellow-500/30 bg-yellow-500/5 px-4 py-3">
        ...
        <p class="text-sm text-foreground mb-3">{askQuestion}</p>
            ...
            {#each parsedQuestions as pq}
              <div>
                {#if pq.header}
                  ...
                  >
                {/if}
                <p class="text-sm text-foreground mb-1">{pq.question}</p>
              ...
              {#each parsedQuestions as pq}
                <div>
                  {#if pq.header}
                    ...
                    >
                  {/if}
                  <p class="text-sm text-foreground mb-1.5">{pq.question}</p>
                  <div class="flex flex-wrap gap-1.5">
                    {#each pq.options as option}
                      <button
